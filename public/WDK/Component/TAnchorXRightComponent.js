/**
 * TAnchorXRightComponent
 */

function TAnchorXRightComponent() {
	const ctx = {
		object: null,
		x: null
	};
	...
	return {
		...
		GetX: function() {
			...
			return TTransform_GetX(transform) - pW + TTransform_GetWidth(transform) / 2
		},
		...
		SetX: function(x) {
			...
			TTransform_SetX(transform, ctx.x + pW - TTransform_GetWidth(transform) / 2);
		},
